...
/**
 * Event fired when a mailwhistle audience tag definition is created.
 *
 * objectid = id of the new row in {local_mailwhistle_tag}.
...
class tag_created extends \core\event\base {
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = 'local_mailwhistle_tag'; // Tag-definition table.
    }
    ...
    public static function get_name(): string {
        return get_string('event_tag_created', 'local_mailwhistle');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' created the mailwhistle tag with id '{$this->objectid}'.";
    }
